...
class MigrationCommand extends Command
{
    ...
    public function handle()
    {
        ...
        $this->comment('A migration that creates "ratings" tables will be created in the ' . database_path('migrations') . ' directory');
        $this->line('');
        ...
        if ($this->confirm("Proceed with the migration creation?")) {
            ...
            if ($this->createMigration()) {
                ...
                $this->error(
                    ...
                    " within the " . database_path('migrations') . " directory."
                );
            }
